...
export const BurgerModal = ({ setBurger }) => {
    return (
        <div className={css.burger__list}>
            ...
            <ul className={css.burger__links}>
                <li onClick={() => setBurger(false)}>
                    <a className={css.burger__link} href="#">
                        Главная
                    </a>
                </li>
                <li onClick={() => setBurger(false)}>
                ...
                <li onClick={() => setBurger(false)}>
                    <a className={css.burger__link} href="#reviews">
                        Отзывы
                    </a>
                </li>
                <li onClick={() => setBurger(false)}>
                    <a className={css.burger__link} href="#materials">
                        Статьи
                    </a>
                </li>
                <li onClick={() => setBurger(false)}>
                    <a className={css.burger__link} href="#footer">
                        Контакты
                    </a>
                </li>
            </ul>
